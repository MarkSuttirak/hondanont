...
import { Button, Modal, Checkbox, ModalOverlay,
  ModalContent,
  ModalHeader,
  ModalFooter,
  ModalBody,
...
const LoginPage = () => {
  ...
  return (
    <div className="text-center" style={{marginTop:"25vh"}}>
      ...
      <Button onClick={onOpen} className="bg-white flex items-center w-full justify-center font-bold primary-color" style={{height:"inherit",padding:"15px 20px",border:"none",boxShadow:"none",borderRadius:"8px",fontSize:"19px"}}>
        เข้าสู่ระบบ
      </Button>
    </div>
    ...
    <Modal className="popup-modal policy" isOpen={isOpen} onClose={onClose} isCentered scrollBehavior="inside">
        <ModalOverlay />
        <ModalContent w="90%" h="90%" p="24px" style={{borderRadius:"10px"}}>
          <ModalHeader p={0} style={{fontSize:"18px",fontWeight:"bold"}}>
            <h1 className="font-bold text-center text-2xl mb-8">นโยบายข้อมูลส่วนบุคคล</h1>
          </ModalHeader>
          <ModalBody p={0} style={{fontSize:"14px"}}>
          <h2 className="font-bold text-base">นโยบายความเป็นส่วนตัว</h2>
            <p className="text-sm mt-3 font-medium" style={{color:"#585858"}}>
            มีความมุ่งมั่นในการปกป้องความเป็นส่วนตัวและข้อมูลส่วนบุคคลของลูกค้าและผู้ใช้บริการของเรานโยบายความเป็นส่วน
            ตัวนี้อธิบายถึงประเภทของข้อมูลส่วนบุคคลที่เราเก็บรวบรวมวิธีการเก็บรวบรวมและใช้ข้อมูลนั้นและสิทธิของคุณเกี่ยวกับข้อมูลส่วนบุคคลของคุณโดยการเข้าถึงเว็บไซต์ของเราและ/หรือการใช้บริการของเรา คุณยินยอมให้เราเก็บรวบรวมและใช้
            ...
            <div className="my-10">
              <Checkbox onChange={checkBox} colorScheme='orange'>
                <span className="text-sm">ข้าพเจ้าได้อ่าน และ ยินยอมให้ข้อมูลส่วนบุคคล</span>
              </Checkbox>
            </div>
          </ModalBody>
